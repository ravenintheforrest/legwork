...
import { discoverIssues } from "./discover-issues.js";
...
export const AGENTS: Record<string, AgentDef> = {
  ...
  "discover-issues": discoverIssues,
...
export const PIPELINE = ["discover", "discover-jobs", "discover-issues", "discover-gitlab", "resolve", "enrich", "dedupe", "qualify", "intent", "people", "brief"];
